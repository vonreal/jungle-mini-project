...
const MOCK = {
  ...
  users: [
    { id: 1, username:"user1", nickname:"you", profile_img_path:"assets/img/avatar.jpg" },
    { id: 2, username:"user2", nickname:"i'm", profile_img_path:"assets/img/avatar.jpg" },
    { id: 3, username:"user3", nickname:"we", profile_img_path:"assets/img/avatar.jpg" }
  ],
  feeds: [
    {
      id: 101,
      ...
      comments: [
        { user_id:3, content:"사진이네?", create_date:new Date(Date.now()-80*60*1000).toISOString() }
      ],
    ...
    },
    {
      ...
      likes: [1,2],
      comments: [
        { user_id:1, content:"잘해보자", create_date:new Date(Date.now()-25*60*60*1000).toISOString() },
        { user_id:2, content:"사진 괜찮다", create_date:new Date(Date.now()-24*60*60*1000).toISOString() }
      ],
